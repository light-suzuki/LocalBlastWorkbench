...
- Search nucleotide or protein databases registered by the user
- Inspect alignments and mismatches in BLAST-OR
- Register and inspect `makeblastdb` prefixes
...
- WSL packages: Python 3, `python3-venv`, NCBI BLAST+, and `netcat-openbsd`
...
git clone https://github.com/light-suzuki/LocalBlastWorkbench.git
cd LocalBlastWorkbench
.\start_windows.bat
```
